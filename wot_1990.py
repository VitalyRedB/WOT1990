...
resources = 'resources'
sounds = f'{resources}/sounds'
images = f'{resources}/images'
dance  = f'{resources}/dance'

sound_effect1 = pygame.mixer.Sound(f'{sounds}/TUK.mp3')
sound_effect2 = pygame.mixer.Sound(f'{sounds}/shot.wav')
sndEngine = pygame.mixer.Sound(f'{sounds}/engine.wav')
sndEngine.set_volume(0.2)
sndMove = pygame.mixer.Sound(f'{sounds}/move.wav')
sndMove.set_volume(0.2)
sndStar = pygame.mixer.Sound(f'{sounds}/star.wav')
sndLive = pygame.mixer.Sound(f'{sounds}/live.wav')
...
imgBrick = pygame.image.load(f'{images}/block_brick.png')
...
imgDance = [pygame.image.load(f'{dance}/dance_left{i}.png') for i in range(0,8)]

imgBonuses = [pygame.image.load(f'{images}/bonus_star.png'),
              pygame.image.load(f'{images}/bonus_tank.png'),
              pygame.image.load(f'{images}/bonus_bomb.png')]

screen = pygame.display.set_mode((width, height))
pygame.display.set_caption("My WOT1990 OD2024 KVO75")
pygame.display.set_icon(pygame.image.load(f'{images}/dom.png').convert_alpha())
...
def restart_game():
    ...
    sound_effect1.play()
    pygame.mixer.music.load(f'{sounds}/GTA.mp3')
...
while play:
    ...
    if isWin and timer == 1000:
        sndMove.stop()
        sndEngine.stop()
        pygame.mixer.music.load(f'{dance}/Dance.mp3')
